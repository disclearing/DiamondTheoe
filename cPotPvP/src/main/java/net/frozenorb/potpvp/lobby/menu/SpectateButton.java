...
final class SpectateButton extends Button {
    ...
    public String getName(Player player) {
        return ChatColor.AQUA.toString() + ChatColor.BOLD + match.getSimpleDescription(false);
    }
    ...
    public List<String> getDescription(Player player) {
        ...
        description.add("");
        description.add(ChatColor.AQUA + "Kit: " + ChatColor.WHITE + match.getKitType().getDisplayName());
        description.add(ChatColor.AQUA + "Arena: " + ChatColor.WHITE + match.getArena().getSchematic());
        ...
        description.add(ChatColor.AQUA + "Spectators: " + ChatColor.WHITE + spectators.size());
        ...
        if (teamA.getAliveMembers().size() != 1 || teamB.getAliveMembers().size() != 1) {
            ...
            description.add(ChatColor.AQUA + "   vs.");
