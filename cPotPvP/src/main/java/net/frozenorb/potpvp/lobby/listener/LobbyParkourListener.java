            ...
            if (block.getType() == Material.IRON_PLATE) {
                ...
                if (block.getRelative(BlockFace.DOWN).getType() == Material.EMERALD_BLOCK) {
                    ...
                    if (parkour == null) {
                        ...
                        player.sendMessage(ChatColor.AQUA + "You've started the " + ChatColor.DARK_AQUA + "parkour" + ChatColor.AQUA + " challenge!");
                    }

                } else if (block.getRelative(BlockFace.DOWN).getType() == Material.REDSTONE_BLOCK) {
                    Parkour parkour = parkourMap.get(player.getUniqueId());
                    if (parkour != null) {
                        player.sendMessage(ChatColor.AQUA + "You've finished the " + ChatColor.DARK_AQUA + "parkour" + ChatColor.AQUA + " challenge!");
                        parkour.getCheckpoint().ring(player);
                ...
                if (parkour != null) {
                    ...
                    if (!checkpoint.getLocation().equals(block.getLocation())) {
                        ...
                        parkour.getCheckpoint().ring(player);
                        player.sendMessage(ChatColor.AQUA + "You've reached a new" + ChatColor.DARK_AQUA + " checkpoint" + ChatColor.AQUA + "!");
                    }
                }
            }
        }
