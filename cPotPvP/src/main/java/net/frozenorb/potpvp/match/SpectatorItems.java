...
public final class SpectatorItems {
    ...
    static {
        ItemUtils.setDisplayName(SHOW_SPECTATORS_ITEM, ChatColor.AQUA + "Show spectators" + GRAY + " (Right Click)");
        ItemUtils.setDisplayName(HIDE_SPECTATORS_ITEM, ChatColor.AQUA + "Hide spectators" + GRAY + " (Right Click)");

        ItemUtils.setDisplayName(VIEW_INVENTORY_ITEM, ChatColor.AQUA + "View player inventory" + GRAY + " (Right Click)");

        ItemUtils.setDisplayName(RETURN_TO_LOBBY_ITEM, ChatColor.AQUA + "Return to lobby" + GRAY + " (Right Click)");
        ItemUtils.setDisplayName(LEAVE_PARTY_ITEM, ChatColor.RED + "Leave party" + GRAY + " (Right Click)");
    }
