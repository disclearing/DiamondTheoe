    ...
    public void onPlayerInteract(PlayerInteractEvent event) {
        ...
        for (Kit kit : kitHandler.getKits(player, kitType)) {
            if (kit.isSelectionItem(clickedItem)) {
                kit.apply(player);
                player.sendMessage(ChatColor.AQUA + "You equipped your \"" + kit.getName() + "\" " + kitType.getDisplayName() + " kit.");
                return;
            }
        }
        ...
        if (defaultKit.isSelectionItem(clickedItem)) {
            ...
            player.sendMessage(ChatColor.AQUA + "You equipped the default kit for " + kitType.getDisplayName() + ".");
        }
