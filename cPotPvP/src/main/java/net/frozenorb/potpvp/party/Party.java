...
public final class Party {
    ...
    public void invite(Player target) {
        ...
        message(ChatColor.DARK_GREEN + CoreAPI.INSTANCE.getProfile(target.getUniqueId()).getNameWithColor() + ChatColor.GREEN + " has been invited to join your party.");
    ...
    public void join(Player player) {
        ...
        player.sendMessage(ChatColor.AQUA + "You have joined " + ChatColor.DARK_AQUA + CoreAPI.INSTANCE.getProfile(leaderBukkit.getUniqueId()).getNameWithColor() + ChatColor.AQUA + "'s party.");

        message(ChatColor.DARK_GREEN + CoreAPI.INSTANCE.getProfile(player.getUniqueId()).getNameWithColor() + ChatColor.GREEN + " has joined your party.");
    ...
    public void leave(Player player) {
        ...
        if (leader.equals(player.getUniqueId())) {
            ...
            message(ChatColor.ALL_CODES + CoreAPI.INSTANCE.getProfile(newLeader.getUniqueId()).getNameWithColor() + ChatColor.AQUA + " has been randomly promoted to leader of your party.");
        }
    ...
    public void setLeader(Player player) {
        ...
        message(ChatColor.DARK_AQUA + player.getName() + ChatColor.AQUA + " has been promoted to leader of your party.");
        resetInventoriesDelayed();
    }
    ...
    public void kick(Player player) {
        ...
        player.sendMessage(ChatColor.AQUA + "You have been kicked from your party.");
        message(ChatColor.DARK_RED + CoreAPI.INSTANCE.getProfile(player.getUniqueId()).getNameWithColor() + ChatColor.GREEN + " has been kicked from your party.");
