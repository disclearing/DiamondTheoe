...
public final class PartyInfoCommand {
    ...
    public static void partyInfo(Player sender, @Param(name = "player", defaultValue = "self") Player target) {
        ...
        sender.sendMessage(ChatColor.AQUA + "Leader: " + ChatColor.WHITE + leaderName);
        sender.sendMessage(ChatColor.AQUA + "Members " + ChatColor.WHITE + "(" + memberCount + ")" + ChatColor.AQUA + ": " + ChatColor.GRAY + members);

        switch (party.getAccessRestriction()) {
            case PUBLIC:
                sender.sendMessage(ChatColor.AQUA + "Privacy: " + ChatColor.GREEN + "Open");
                break;
            case INVITE_ONLY:
                sender.sendMessage(ChatColor.AQUA + "Privacy: " + ChatColor.GOLD + "Invite-Only");
                break;
            case PASSWORD:
                ...
                if (party.isLeader(sender.getUniqueId())) {
                    ...
                    sender.sendMessage(ChatColor.AQUA + "Privacy: " + ChatColor.RED + "Password Protected");
                }
