            ...
            toReturn.put(toReturn.isEmpty() ? 0 : toReturn.size(), new Button() {
                ...
                public void clicked(Player player, int slot, ClickType clickType) {
                    if (party.isLeader(player.getUniqueId())) {
                        ...
                        party.message(player.getDisplayName() + ChatColor.AQUA + " has set " + member.getDisplayName() +  ChatColor.AQUA + "'s " + ChatColor.AQUA + " kit to " + ChatColor.GRAY + next.getName() + ChatColor.AQUA + ".");
