...
public final class PartyItems {
    ...
    static {
        ...
        ItemUtils.setDisplayName(ASSIGN_CLASSES, GOLD + "HCF Kits" + GRAY + " (Right Click)");
        ItemUtils.setDisplayName(START_TEAM_SPLIT_ITEM, YELLOW + "Start Team Split" + GRAY + " (Right Click)");
        ItemUtils.setDisplayName(START_FFA_ITEM, YELLOW + "Start Party FFA" + GRAY + " (Right Click)");
        ItemUtils.setDisplayName(OTHER_PARTIES_ITEM, GREEN + "Other Parties" + GRAY + " (Right Click)");
    }
    ...
    public static ItemStack icon(Party party) {
        ...
        String displayName = AQUA.toString() + leaderName + AQUA + "'s Party" + GRAY + " (Right Click)";
