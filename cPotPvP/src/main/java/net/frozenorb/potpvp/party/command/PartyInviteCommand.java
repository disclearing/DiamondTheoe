...
public final class PartyInviteCommand {
    ...
    public static void partyInviteAll(Player sender) {
        ...
        if (sent == 0) {
            sender.sendMessage(ChatColor.RED + "No invites to send.");
        } else {
    ...
    private static void askLeaderToInvite(Party party, Player requester, Player target) {
        requester.sendMessage(ChatColor.AQUA + "You have requested to invite " + ChatColor.DARK_AQUA + CoreAPI.INSTANCE.getProfile(target.getUniqueId()).getNameWithColor() + ChatColor.AQUA + ".");
        ...
        leader.sendMessage(CoreAPI.INSTANCE.getProfile(requester.getUniqueId()).getNameWithColor() + ChatColor.AQUA + " wants you to invite " + CoreAPI.INSTANCE.getProfile(target.getUniqueId()).getNameWithColor() + ChatColor.AQUA + ".");
