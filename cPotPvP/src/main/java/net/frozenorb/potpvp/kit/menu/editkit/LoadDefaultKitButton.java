...
final class LoadDefaultKitButton extends Button {
    ...
    public String getName(Player player) {
        return ChatColor.DARK_GREEN.toString() + ChatColor.BOLD + "Load default kit";
    }
    ...
    public List<String> getDescription(Player player) {
        return ImmutableList.of(
            "",
            ChatColor.DARK_GREEN + "Click this to load the default kit",
            ChatColor.DARK_GREEN + "into the kit editing menu."
        );
    }
