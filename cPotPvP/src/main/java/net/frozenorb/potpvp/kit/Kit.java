...
public final class Kit {
    ...
    public boolean isSelectionItem(ItemStack itemStack) {
        ...
        return meta.hasDisplayName() && meta.getDisplayName().equals(ChatColor.AQUA.toString() + ChatColor.BOLD + name);
    }
    ...
    public ItemStack createSelectionItem() {
        ...
        itemMeta.setDisplayName(ChatColor.AQUA.toString() + ChatColor.BOLD + name);
