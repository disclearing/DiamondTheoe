...
final class KitRenameButton extends Button {
    ...
    public String getName(Player player) {
        return ChatColor.DARK_GRAY.toString() + ChatColor.BOLD + "Rename";
    }
    ...
    public List<String> getDescription(Player player) {
        return ImmutableList.of(
            "",
            ChatColor.DARK_GRAY + "Click to rename this kit."
        );
    }
    ...
    public void clicked(Player player, int slot, ClickType clickType) {
        ...
        return ChatColor.AQUA + "Renaming " + ChatColor.DARK_AQUA + kit.getName() + ChatColor.AQUA +"... " + ChatColor.GREEN + "Enter the new name now.";
            }
            ...
            public Prompt acceptInput(ConversationContext ctx, String s) {
                ...
                ctx.getForWhom().sendRawMessage(ChatColor.GREEN + "Kit renamed.");
