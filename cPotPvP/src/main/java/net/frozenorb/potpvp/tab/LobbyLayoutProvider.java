...
final class LobbyLayoutProvider implements BiConsumer<Player, TabLayout> {
    ...
    public void accept(Player player, TabLayout tabLayout) {
        ...
        rankings: {
            tabLayout.set(1, 3, ChatColor.AQUA.toString() + ChatColor.BOLD + "Your Rankings");
            ...
            for (KitType kitType : KitType.getAllTypes()) {
                ...
                tabLayout.set(x++, y, ChatColor.AQUA + kitType.getDisplayName() + " - " + eloHandler.getElo(player, kitType));
        ...
        party: {
            ...
            for (UUID member : getOrderedMembers(player, party)) {
                ...
                String displayName = suffix + ChatColor.BLUE + CoreAPI.INSTANCE.getProfile(member).getNameWithColor();
