...
public class PingCommand {
    ...
    public static void ping(Player sender, @Param(name = "target", defaultValue = "self") Player target) {
        ...
        sender.sendMessage(CoreAPI.INSTANCE.getProfile(target.getUniqueId()).getNameWithColor() + ChatColor.GRAY + "'s Ping: " + ChatColor.GREEN + ping + "ms");
                ...
                for (MatchTeam team : match.getTeams()) {
                    for (UUID other : team.getAllMembers()) {
                        ...
                        if (otherPlayer != null && !otherPlayer.equals(sender)) {
                            ...
                            sender.sendMessage(CoreAPI.INSTANCE.getProfile(otherPlayer.getUniqueId()).getNameWithColor() + ChatColor.GRAY + "'s Ping: " + ChatColor.GREEN + otherPing + "ms");
                        }
                    }
                }
            }
