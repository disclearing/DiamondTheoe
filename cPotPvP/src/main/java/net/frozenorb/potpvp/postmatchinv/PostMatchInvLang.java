...
public final class PostMatchInvLang {
    ...
    static final String INVENTORY_HEADER = ChatColor.DARK_AQUA + "Post-Match Inventories " + ChatColor.GRAY + "(Click name to view)";
    ...
    private static final String PARTICIPANTS = ChatColor.GRAY + "Participants:";

    private static final TextComponent COMMA_COMPONENT = new TextComponent(", ");

    static {
        COMMA_COMPONENT.setColor(ChatColor.AQUA);
    }
    ...
    private static TextComponent clickToViewLine(UUID member) {
        ...
        component.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder(ChatColor.GREEN + "Click to view inventory of " + ChatColor.DARK_AQUA + memberName).create()));
