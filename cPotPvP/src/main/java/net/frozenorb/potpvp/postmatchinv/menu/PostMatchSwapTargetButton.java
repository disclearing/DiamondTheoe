...
final class PostMatchSwapTargetButton extends Button {
    ...
    public String getName(Player player) {
        return ChatColor.GREEN + "View " + CoreAPI.INSTANCE.getProfile(newTarget.getPlayerUuid()).getNameWithColor() + ChatColor.GREEN + "'s inventory";
    }
    ...
    public List<String> getDescription(Player player) {
        return ImmutableList.of(
            "",
            ChatColor.GREEN + "Swap your view to " + CoreAPI.INSTANCE.getProfile(newTarget.getPlayerUuid()).getNameWithColor() + ChatColor.GREEN + "'s inventory"
        );
    }
