...
public final class ManageSchematicMenu extends Menu {
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        buttons.put(4, new net.frozenorb.potpvp.arena.menu.manageschematic.SaveModelButton(schematic));
        ...
        if (PotPvPSI.getInstance().getArenaHandler().getGrid().isBusy()) {
            ...
            buttons.put(7, new net.frozenorb.potpvp.arena.menu.manageschematic.CreateCopiesButton(schematic));
            buttons.put(8, new net.frozenorb.potpvp.arena.menu.manageschematic.RemoveCopiesButton(schematic));
        }
