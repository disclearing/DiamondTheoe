    ...
    public List<String> getDescription(Player player) {
        if (schematic.isEnabled()) {
            return ImmutableList.of(
                "",
                ChatColor.AQUA + "Click to disable " + schematic.getName() + ", which will prevent matches",
                ChatColor.AQUA + "being scheduled on these arenas. Admin",
                ChatColor.AQUA + "commands will not be impacted."
            );
        } else {
            return ImmutableList.of(
                    "",
                    ChatColor.AQUA + "Click to enable " + schematic.getName() + ", which will allow matches",
                    ChatColor.AQUA + "to be scheduled on these arenas."
            );
        }
    }
