    ...
    open fun broadcastWinner(winner: GameTeam) {
        for (player in Bukkit.getOnlinePlayers()) {
            player.sendMessage(arrayOf("",
                    ...
                    ChatColor.GRAY.toString() + "█" + ChatColor.AQUA + "█████" + ChatColor.GRAY + "█" + " " + ChatColor.AQUA + "[${game.event.getName()} Event Winner]",
                    ChatColor.GRAY.toString() + "█" + ChatColor.AQUA + "█" + ChatColor.GRAY + "█████" + " ",
                    ChatColor.GRAY.toString() + "█" + ChatColor.AQUA + "████" + ChatColor.GRAY + "██" + " " + winner.getName() + ChatColor.GRAY + " has won the event!",
                    ChatColor.GRAY.toString() + "█" + ChatColor.AQUA + "█" + ChatColor.GRAY + "█████" + " ",
