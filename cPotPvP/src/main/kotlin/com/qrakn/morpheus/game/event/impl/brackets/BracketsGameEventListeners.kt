    ...
    fun onPlayerInteractEntityEvent(event: PlayerInteractEntityEvent) {
        ...
        if (event.rightClicked is Player && (player.itemInHand == null || player.itemInHand.type == Material.AIR)) {
            ...
            if (game.players.contains(player) && game.players.contains(clicked) && game.state == GameState.STARTING) {
                ...
                clicked.sendMessage("")
                clicked.sendMessage(player.displayName + org.bukkit.ChatColor.AQUA + " would like to team with you.")
                clicked.sendMessage(org.bukkit.ChatColor.AQUA.toString() + "Right-click them to accept.")
                clicked.sendMessage("")
                player.sendMessage(org.bukkit.ChatColor.AQUA.toString() + "You sent a team request to " + clicked.displayName + org.bukkit.ChatColor.AQUA + ".")
