            ...
            if (!contains(player)) {
                for (other in game.players) {
                    if (player != other && !contains(other)) {
                        player.sendMessage(ChatColor.AQUA.toString() + "You were automatically put into a team with " + other.displayName + ChatColor.AQUA + "")
                        other.sendMessage(ChatColor.AQUA.toString() + "You were automatically put into a team with " + player.displayName + ChatColor.AQUA + "")
